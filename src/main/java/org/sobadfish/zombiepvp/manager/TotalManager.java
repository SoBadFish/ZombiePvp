...
import org.sobadfish.zombiepvp.manager.data.PlayerDataManager;
import org.sobadfish.zombiepvp.manager.data.PlayerTopManager;
import org.sobadfish.zombiepvp.manager.data.TagItemDataManager;
import org.sobadfish.zombiepvp.panel.lib.AbstractFakeInventory;
import org.sobadfish.zombiepvp.room.config.GameRoomConfig;
import org.sobadfish.zombiepvp.room.event.defaults.ChestResetEvent;
...
public class TotalManager {
     ...
     * 游戏指令
     * */
    public static String COMMAND_NAME = "zp";

    /**
     * 游戏管理员指令
     * */
    public static String COMMAND_ADMIN_NAME = "zpa";

    /**
     * 游戏内喊话指令
     * */
    public static String COMMAND_MESSAGE_NAME = "zps";

    /**
     * 小游戏名称
     * */
    public static final String GAME_NAME = "ZombiePvP";
